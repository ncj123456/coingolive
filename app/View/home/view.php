            ...
            <div class="row">
                <div class="col-md-4 ml-auto mr-auto">
                    <div class="card card-body" >
                        <h2 class="text-center" style=" font-size: 30px;"><?= _e('Cotação máxima das criptomoedas') ?></h2>
                ...
                <div class="col-md-4">
                    <div class="card card-body" >
                        <h2 class="text-center" style=" font-size: 30px;"><?= _e('Alta histórica das Criptomoedas') ?></h2>
                ...
                <div class="col-md-4 ml-auto mr-auto">
                    <div class="card card-body" >
                        <h2 class="text-center" style=" font-size: 30px;"><?= _e('Histórico de crescimento criptomoedas') ?></h2>
                ...
                <div class="col-md-4">
                    <div class="card card-body" >
                        <h2 class="text-center" style=" font-size: 30px;"><?= _e('Variação das criptomoedas em 24h') ?></h2>
