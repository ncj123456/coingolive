...
<div class="card">
    <div class="text-center">
        ...
        <p style="margin-top: 0;margin-bottom: 15px;margin-right: 10px;margin-left: 10px;">Nosso robô busca constantemente novos conteúdos no Youtube, fique atualizado!</p>
    </div>
</div>
<hr/>
